...
while r_factor > 1.5:
	i = start_cycle
	mof_taxi.write_raspa_input(temp=temperature,pressure=pressure,cyclenumber=i,cycles=1000,adsorbate=adsorbate,framework=f_prefix,rosenbluth=1.000)
