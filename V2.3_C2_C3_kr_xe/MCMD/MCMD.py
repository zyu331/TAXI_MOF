...
########################Main MC MD loop###########################
    i = start_cycle
    mof_taxi.write_raspa_input(temp=temperature,pressure=pressure,cyclenumber=i,cycles=100000,adsorbate=adsorbate,framework=f_prefix,rosenbluth=rosenbluth,HeliumVoidFraction=voidFrac,startNUM= NUMofad )
