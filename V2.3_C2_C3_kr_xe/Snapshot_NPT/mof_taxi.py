...
def write_lammps_input(temp=None, pressure=None, md_time=None, cyclenumber=None,framework=None,elementArray=None):
    if temp is None:
        print('you must specify a temperature')
        return
    if pressure is None:
...
atom_style full\n
pair_style hybrid/overlay lj/cut 12.5
...
############################ Record thermodynamic data #################################################
    ...
    f.write("""            
############################### minimization ###########################################################
            dump opt_frame all custom 10000 fig/opt_framework_* id type xs ys zs q
...
############################### NPT ###########################################################
            dump npt_struc all custom 10000 fig/npt_framework_* id type xs ys zs q
            reset_timestep 0
